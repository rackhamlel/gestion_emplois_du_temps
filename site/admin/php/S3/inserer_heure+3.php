...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == "Valider") {
        ...
        $diffJours = $numeroJour[$jourSemaine] - $dateDebut->format('N') + 21;
        ...
        $requete->execute();
        header('location:emploi_temps_+3.php');
        ...
        if (array_key_exists($jourSemaine, $numeroJour)) {
            ...
            WEEK(DateHeureEmbauche) = :jourSemaine AND WEEK(DateHeureEmbauche) = WEEK(NOW()) + 3");
