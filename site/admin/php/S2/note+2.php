...
$date_plus_14_jours = date('Y-m-d H:i:s', strtotime('+14 days', strtotime($date_actuelle)));
...
try {
    ...
    $stmt->bindParam(':dateNote', $date_plus_14_jours);
    $stmt->bindParam(':contenuNote', $contenuNote);
    $stmt->bindParam(':id_utilisateur', $id_utilisateur);
    $stmt->execute();
    
    header('location:../S2/emploi_temps_+2.php');
